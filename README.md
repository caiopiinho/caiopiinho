...
💻 Tenho experiência com Java e SQL (MySQL, SQL Server, Postgres) e atualmente estou aprimorando minhas habilidades em Python. Também possuo prática em edição de imagens e vídeos (Photoshop, Premiere, Figma, Canva, Adobe XD, Gimp) e familiaridade com Windows e Linux (Ubuntu), diversas IDEs, ferramentas de desenvolvimento, softwares de produtividade e IA moderna (ChatGPT, Google Gemini, DeepSeek, Claude, Blackbox.ai).<br>
